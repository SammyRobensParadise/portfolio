...
const Policy: NextPage = (): JSX.Element => {
  const { paint } = useTransition({ timeout: 0 })
          ...
          >
            <div className="space-y-4 py-4">
              <p className="text-shadow dark:text-off-white text-lg">
                It is Sammy Robens-Paradise&apos;s policy to respect your
                privacy regarding any information we may collect while operating
                my website. This Privacy Policy applies to https://sammy.world
                ...
                to information we/I collect through the Website and does not
                apply to my collection of information from other sources. This
                Privacy Policy, together with the Terms and conditions posted on
                our/my Website, set forth the general rules and policies
                governing your use of our/my Website. Depending on your
                activities when visiting my Website, you may be required to
                agree to additional terms and conditions.
              </p>
              <p className="text-shadow dark:text-off-white text-lg">
                To enrich and perfect your online experience, Sammy
                Robens-Paradise uses &quot;Cookies&quot;, similar technologies
                ...
                using Sammy Robens-Paradise&apos;s websites, with the drawback
                that certain features of Sammy Robens-Paradise&apos;s websites
                may not function properly without the aid of cookies. By
                continuing to navigate our/my website without changing your
                cookie settings, you hereby acknowledge and agree to Sammy
                Robens-Paradise&apos;s use of cookies. © 2021 Sammy
                Robens-Paradise Thank you.
              </p>
              <p className="text-shadow dark:text-off-white text-lg">
                {`© ${new Date()
                  .getFullYear()
