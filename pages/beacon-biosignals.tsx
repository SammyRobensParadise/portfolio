      ...
      <div>
        ...
        >
          ...
          <ul className="list-inside list-disc space-y-2 text-shadow dark:text-off-white text-lg py-4">
            ...
            <li>
              Problem-solve alongside neurologists and data scientists to design
              and develop web-based tools bring neuroscience tooling to the web.
            </li>
            <li>
          ...
          <div className="space-y-4">
            <p className="text-shadow dark:text-off-white text-lg">
              ...
              accelerate clinical trials and enable new treatments for patients
              with neurological and psychiatric disease. By using advanced
              machine learning to quicly identify critical biomarkers Beacon can
              surface only the most critical information for neurologists to
              make life altering decisions. The problem? Looking at brain data
              isn’t exactly straight forward, and as a result, neither are the
            ...
            <p className="text-shadow dark:text-off-white text-lg">
              ...
              information is required. More data means more processing time, and
              when it comes to the world wide web, this means more latency. Data
              latency proves detremental to the workflow of neurologists and
              data scientists who rely on Beacon’s portal to adjudicate
              brainwave data. A solution bringing post-processed data to the
              client without latency was needed.
            </p>
          </div>
          <h3 className="text-2xl justify-start text-left block py-4 text-cerulaen dark:text-off-white font-bold">
            The Solution
          ...
          <div className="space-y-4">
            <p className="text-shadow dark:text-off-white text-lg">
              To increase the speed at which processed data could be sent to the
              client, the bottleneck needed to be itentified. On the frontend, I
              did not need to look far. Javascript is single threaded. Meaning
              that although asyncronous and done via web socket, loading
              brainwave data into the browser would block the main thread. This
              inhibited renders and additional processes degrading the
              platform’s UX.
            </p>
            <p className="text-shadow dark:text-off-white text-lg">
              ...
              the main javascript thread to carry on in peace. I architected the
              worker to harness message chunking, and autonomous streaming,
              further reducing message overhead. Once the data was in the
              browser, I implemented a caching algorithm to ensure the client
              would not attempt to re-fetch data it already had.
            </p>
          </div>
          <h3 className="text-2xl justify-start text-left block py-4 text-cerulaen dark:text-off-white font-bold">
            Results
          ...
          <div className="space-y-4">
            <p className="text-shadow dark:text-off-white text-lg">
              Initial benchmarks shwed an average speed increase of 300%, and up
              to 1000% increases in cases where data had been cached in the
              ...
              processing in the browser. A first for the world of neuroscience.
            </p>
          </div>
        </Transition>
